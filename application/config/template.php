...
$template['blank']['template'] = '../../themes/'.$theme_name.'/blank';
$template['blank']['theme_folder'] = $theme_name;

// $template['blank_iframe']['template'] =  '../../themes/wb2/blank';
// $template['blank_iframe']['theme_folder'] = 'wb2';
$template['blank_iframe']['template'] =  '../../themes/'.$theme_name.'/blank';
$template['blank_iframe']['theme_folder'] = $theme_name;
