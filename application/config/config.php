...
// IHSN - List of supported languages. type language name in lower case
// array("english","french","arabic","russian","spanish","mongolian");
$config['supported_languages']=array();

/*
|--------------------------------------------------------------------------
| IHSN - Allowed IP addresses to access site administration
|--------------------------------------------------------------------------
|
...
|--------------------------------------------------------------------------
|
| Enabling this setting will tell CodeIgniter to look for aComposer
...
|
| Note: This will NOT disable or override the
...
*/
// $config['log_path'] = '';
// IHSN - Moving the logs to system/logs
...
|--------------------------------------------------------------------------
|
| The default filename extension for log files. The default 'php' allows
...
| default application/views/errors/ directory.  Use a full server path
| with trailing slash.
|
*/
...
|--------------------------------------------------------------------------
|
| Whether to take the URL query string into consideration when
| generating output cache files. Valid options are:
|
|       FALSE = Disabled TRUE = Enabled, take all query parameters into
|       account.
|                    Please be aware that this may result in numerous
|       cache files generated for the same page over and over again.
|       array('q') = Enabled, but only take into account the specified
|       list
|                    of query parameters.
|
*/
...
/*
 @todo Remove Upgrade 3.x instructions
...
$config['sess_expiration']		= 0; // 3.x Upgrade Instructions

$config['sess_regenerate_destroy'] = FALSE;

// @todo Option to install NADA Uncomment this section
/*
*/
$config['sess_use_database']	= FALSE;

// --------------------------------------------------
//   @todo 3.x upgrade Session config
//	This version use files to store the session information
//   --------------------------------------------------
...
/*
	@todo To operate as IHNS designed, uncomment this section
*/
/*
$config['sess_use_database']	= TRUE;
$config['sess_driver'] = 'database';
// CI 2.x to 3.x variable modification save_path = table_name
...
*/
// @todo csv added
$config['allowed_resource_types']='jpg,gif,png,zip,doc,docx,pdf,sav,dta,txt,xls,xlsx,ppt,csv';
...
| This variable should match with the PHP configuration
|
*/
...
/*
|--------------------------------------------------------------------------
| Directory path to the javascript files location
|
|--------------------------------------------------------------------------
