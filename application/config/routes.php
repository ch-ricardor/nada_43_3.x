...
|
| This is not exactly a route, but allows you to automatically route controller
| and method names that contain dashes. '-' isn't a valid class or method name
| character, so it requires translation. When you set this option to TRUE, it will
| replace ALL dashes in the controller and method URI segments.
|
...
/*
   @todo RRE Fix HMVC
	Check if admin controller shopuld be working under this structure.
	HMVC version 5.5 returning Error 404
	This test redirects to a directory structure not defined in
	modules to SKIP the HMVC validation ln -s admin adminihns
	these rotues worked.
*/
/*
$route['admin'] = "adminihns/admin";
$route['admin/users'] = "adminihns/users";
$route['admin/catalog'] = "adminihns/catalog";
$route['admin/configurations'] = "adminihns/configurations";
$route['admin/dashboard'] = "adminihns/admin";
$route['admin/licensed_requests'] = "adminihns/licensed_requests";
$route['admin/regions'] = "adminihns/regions";
$route['admin/reports'] = "adminihns/reports";
$route['admin/repositories'] = "adminihns/repositories";
*/
...
// @todo 2.x to 3.x Upgrade Test if (:any) needs to be (.+)
// $route['access_public/(:num)/download/(:any)'] = "access_public/download/$1/$2";
