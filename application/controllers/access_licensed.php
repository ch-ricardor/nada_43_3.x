...
class Access_licensed extends MY_Controller {
	...
	*/
	function track($request_id)
	{
		...
		// @todo verify config['javascript_location'] definition
		...
		$this->template->add_js($this->config->item('javascript_location').'/jquery/ui/minified/jquery.ui.accordion.min.js');
