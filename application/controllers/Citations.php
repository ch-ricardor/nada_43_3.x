...
class Citations extends MY_Controller {
	...
	*/
	...
	function _search()
	{
		...
		//records
		// @todo Check Citation_model_search
	...
	**/
	...
	function view($citationid=NULL)
	{
		...
		// if ($this->input->post_get("ajax")!==false || $this->input->post_get("print")!==false)
		if ($this->input->post_get("ajax")!==NULL || $this->input->post_get("print")!==NULL)
		{
			$this->template->set_template('blank');
		}
