...
class Repositories extends MY_Controller {
	...
	function index()
	{
		...
		// @todo Renamed to index_default
		// $content=$this->load->view('repositories/index-default', $result,true);
		$content=$this->load->view('repositories/index_default', $result,true);
	...
	*/
	function edit($id=NULL)
	{
		...
		*/
		...
		$this->form_validation->set_rules('repositoryid', t('repositoryid'), 'trim|required|max_length[255]|callback__repository_identity_check|alpha_dash');
		...
		$this->form_validation->set_rules('short_text', t('short_text'), 'trim|required');
		$this->form_validation->set_rules('long_text', t('long_text'), 'trim');
		$this->form_validation->set_rules('weight', t('weight'), 'trim|max_length[5]|is_natural');
		$this->form_validation->set_rules('thumbnail', t('thumbnail'), 'trim|required');
		$this->form_validation->set_rules('section', t('section'), 'trim|max_length[3]|is_natural');
		$this->form_validation->set_rules('published', t('published'), 'trim|max_length[1]|is_natural');
