...
*/
		$this->form_validation->set_rules('username', t('username'), 'max_length[20]|required|callback_username_exists');
		$this->form_validation->set_rules('email', t('email'), 'max_length[100]|required|valid_email|callback_email_exists');
	...
	function edit($id)
	{
    	...
    	$this->form_validation->set_rules('email', t('email'), 'max_length[100]|required|valid_email|callback_email_exists');
    	$this->form_validation->set_rules('first_name', t('first_name'), 'trim|required');
    	$this->form_validation->set_rules('last_name', t('last_name'), 'trim|required');
    	$this->form_validation->set_rules('phone1', t('phone'), 'trim');
    	$this->form_validation->set_rules('company', t('company_name'), 'trim');
		...
		else
		{
			...
			{
				// @todo Review:
				// This needed to be commented to remove the errors after the form alidation
