...
class Resources extends MY_Controller {
	...
	*/
	function edit($id='add')
	{
		...
		$this->template->add_css($this->config->item('javascript_location').'/autocomplete/jquery.autocomplete.css');
		$this->template->add_js($this->config->item('javascript_location').'/autocomplete/jquery.autocomplete.pack.js');
	...
	*/
	...
	function _upload_file($key,$destination)
	{
		...
		$config['disallowed_types'] .= '|bat|com|dll|scr|vbe|vbs|wsh';
