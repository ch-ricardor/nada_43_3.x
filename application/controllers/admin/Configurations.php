...
class Configurations extends MY_Controller {
	...
	{
		/*
		 @todo 2.x to 3.x Upgrade xss_clean
		...
		*/
		$this->form_validation->set_rules('catalog_root', t('catalog_folder'), 'trim|max_length[255]');
		$this->form_validation->set_rules('ddi_import_folder', t('ddi_import_folder'), 'trim|max_length[255]');
		$this->form_validation->set_rules('cache_path', t('cache_folder'), 'trim|max_length[255]|callback_check_folder_exists');
		$this->form_validation->set_rules('ddi_import_folder', t('ddi_import_folder'), 'trim|max_length[255]|callback_check_folder_exists');
		$this->form_validation->set_rules('catalog_root', t('catalog_folder'), 'trim|max_length[255]|callback_check_folder_exists');
		$this->form_validation->set_rules('website_title', t('website_title'), 'trim|max_length[255]');
		$this->form_validation->set_rules('language', t('language'), 'trim|max_length[255]');
		$this->form_validation->set_rules('cache_default_expires', t('cache_expiry'), 'trim|max_length[10]|numeric');
		$this->form_validation->set_rules('catalog_records_per_page', t('catalog_records_per_page'), 'trim|max_length[10]|numeric');
