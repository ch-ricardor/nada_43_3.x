...
class Pdf_generator extends MY_Controller {
	...
	function setup($sid=NULL)
	{
		...
		/* @todo RRE CI 2.x to 3.x upgrade xss
		...
		*/
		$this->form_validation->set_rules('website_title', t('website_title'), 'trim|required|max_length[255]');
		$this->form_validation->set_rules('study_title', t('study_title'), 'trim|required|max_length[400]');
		$this->form_validation->set_rules('publisher', t('publisher'), 'trim|max_length[255]');
		$this->form_validation->set_rules('website_url', t('website_url'), 'trim|required|max_length[255]');
