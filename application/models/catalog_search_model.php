...
class Catalog_search_model extends CI_Model {
	...
	**/
	...
	function _build_search_query()
	{
		...
		//row 1
		$search_fields1=$this->input->post_get("field1");// explode(",",$this->input->post_get("field1"));
		$search_keywords1=$this->input->post_get("keyword1");

		//row 2
		$search_fields2=$this->input->post_get("field2");//explode(",",$this->input->post_get("field2"));
		$search_keywords2=$this->input->post_get("keyword2");
	...
	*/
	...
	{
		//row 1
		$search_fields1=$this->input->post_get("field1");
		$search_keywords1=trim($this->input->post_get("keyword1"));

		//row 2
		$search_fields2=$this->input->post_get("field2");
		$search_keywords2=trim($this->input->post_get("keyword2"));
