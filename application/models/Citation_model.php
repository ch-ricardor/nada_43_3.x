...
class Citation_model extends CI_Model {
	...
	function search($limit = NULL, $offset = NULL,$filter=NULL,$sort_by=NULL,$sort_order=NULL,$published=NULL,$repositoryid=NULL)
	{
		...
		/**
		 * @todo Change Query structure to be able to use Query Helper with any driver.
		 * @todo new library libraries/citation_search_default
		 * @todo libraries/citation_search_sql.php has diferent fields. (outdated)
		*/
		$this->load->library('citation_search_default');
		// @todo RRE Enabling the function
		...
		$result=$this->citation_search_default->search($limit, $offset,$filter,$sort_by,$sort_order,$published,$repositoryid);
		$this->search_found_rows=$this->citation_search_default->search_found_rows;
...
*/
	...
	* @todo Same function is in the libraries/citation_searc files
 	**/
