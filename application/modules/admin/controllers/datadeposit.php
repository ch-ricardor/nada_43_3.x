...
class Datadeposit extends MX_Controller {
	...
	public function id($id) {
		...
		// RRE --
		$this->template->add_css($this->config->item('javascript_location').'/jquery/themes/base/ui.all.css');
		$this->template->add_js($this->config->item('javascript_location').'/jquery/ui/ui.core.js');
		$this->template->add_js($this->config->item('javascript_location').'/jquery/ui/ui.tabs.js');
