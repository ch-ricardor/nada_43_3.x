...
class Datadeposit extends MY_Controller {
	...
	**/
	...
	public function upload($id) {
		...
		// RRE
		$this->template->add_css($this->config->item('javascript_location')."/plupload/jquery.plupload.queue/css/jquery.plupload.queue.css");
		$this->template->add_js($this->config->item('javascript_location')."/plupload/plupload.full.js");
		$this->template->add_js($this->config->item('javascript_location')."/plupload/jquery.plupload.queue/jquery.plupload.queue.js");
	...
	public function study($id) {
		...
		$this->template->add_js($this->config->item('javascript_location')."/jquery.treeview/jquery.treeview.js");
		$this->template->add_css($this->config->item('javascript_location')."/jquery.treeview/jquery.treeview.css");
		$this->load->helper('url');
		$this->load->helper('form');
		$this->config->load('datadeposit');
		$this->load->model('Study_model');
