...
//	public function MY_Controller($skip=FALSE,$is_admin=TRUE)
	...
	**/
	function _auth()
	{
		...
		{
			$destination.='/?ajax='.$this->input->post_get("ajax");
		}
		//check if print is set
		if ($this->input->post_get("print"))
		{
			$destination.='/?print='.$this->input->post_get("print");
		}
	...
	*/
	...
	/* ---------------------------------------------------------------------------
	@todo RRE Check if this code is necessary.
