...
<?php endif; ?>
    ...
    <span id="dialog-contents">
    	<iframe
            ...
            scrolling="auto" src="<?php echo $this->config->item('javascript_location');?>/iframeloading.html"></iframe>
        </span>
	</div>
...
$(document).ready(function()
{
	...
	{
		$("#dialog-iframe").attr("src",$this->config->item('javascript_location').'/iframeloading.html');
	}
	//initialize_dialog
	iframe_dialog_init();	
});
