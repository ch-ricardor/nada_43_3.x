                ...
                <div class="<?php echo $class;?>">    	
                    ...
                    <div class="resource-right-col">
                    	<span class="resource-file-size">
							<?php 
								$link_text= '<img src="'.get_file_icon($ext).'" alt="'.$ext.'"  title="'.form_prep(basename($row['filename'])).'"/> ';
								...
								if ($url!='')
								{
									$link_text= '<a target="_blank" href="'.$url.'" title="'.form_prep(basename($row['filename'])).'" class="download">'.$link_text.'</a>';
								}
								else
								{
									$link_text="";
                    ...
                    <?php if ($row['description']!='' || $row['title']!=''  || $row['toc']!='' ):?>                    
                        ...
                        <table class="grid-table tbl-resource-info" >
                            ...
                            <tr>
                                ...
                                <td><?php echo ($link_text==="") ? "N/A" : '<a class="download" title="'.form_prep(basename($row['filename'])).'" href="'.$url.'">'.$url.'</a>';?></td>
                            </tr>                        
                        </table>
