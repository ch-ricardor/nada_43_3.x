<?php
	/* @todo RRE
	 Review calls site_url() vs base_url()
	 images and static code should work with base_url()
	*/
?>
...
<?php
	/*
		@todo RRE - Pagintation total_rows PROTECTED property in CI Pagination.php
	*/
	if ($this->pagination->cur_page>0) {
		...
		*/
		if ($to_page> $this->pagination->getTotal_rows())
		{
			$to_page=$this->pagination->getTotal_rows();
		}
