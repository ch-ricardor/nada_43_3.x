...
<!-- RRE jquery ui -->
<link rel="stylesheet" type="text/css" href="<?php echo $this->config->item('javascript_location');?>/jquery/themes/base/jquery-ui.css" />
...
<!-- RRE -->
<script type="text/javascript" src="<?php echo $this->config->item('javascript_location');?>/jquery/jquery.js"></script>
<script type="text/javascript" src="<?php echo $this->config->item('javascript_location');?>/jquery.ba-bbq.js"></script>
