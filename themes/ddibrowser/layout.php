...
<link rel="stylesheet" type="text/css" href="<?php echo $this->config->item('javascript_location');?>/superfish/css/superfish.css" media="screen">
...
<link rel="stylesheet" type="text/css" href="<?php echo $this->config->item('javascript_location');?>/jquery/themes/ui-lightness/ui.core.css" />
<link rel="stylesheet" type="text/css" href="<?php echo $this->config->item('javascript_location');?>/jquery/themes/ui-lightness/ui.base.css" />
<link rel="stylesheet" type="text/css" href="<?php echo $this->config->item('javascript_location');?>/jquery/themes/ui-lightness/ui.accordion.css" />
<link rel="stylesheet" type="text/css" href="<?php echo $this->config->item('javascript_location');?>/jquery/themes/ui-lightness/ui.theme.css" />

<script src="<?php echo $this->config->item('javascript_location');?>/jquery-1.5.1.min.js"></script>
<script type="text/javascript" src="<?php echo $this->config->item('javascript_location');?>/ui.core.js"></script>
<script type="text/javascript" src="<?php echo $this->config->item('javascript_location');?>/jquery/ui/ui.tabs.js"></script>
<script src="<?php echo $this->config->item('javascript_location');?>/tree/jquery.treeview.pack.js"></script>
	<script>
		$(function(){
			//tree-view 
...
<link rel="stylesheet" href="<?php echo $this->config->item('javascript_location');?>/tree/jquery.treeview.css" />
    ...
    <div id="bd" >
        <div id="inner-body">           
            ...
            <?php
				...
				if ($this->uri->segment(1)=='catalog' && $this->uri->segment(2)!==NULL)
				{
					$show_tab=FALSE;
				}
