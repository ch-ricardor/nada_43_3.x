ASK FOR THE UPDATED BERSION TO THE PROVIDER
IHNS.

This version is not longer valid in new versions
...
CREATE TABLE `surveys` (
  ...
  FULLTEXT KEY `ft_ie` (`ie_program`,`ie_project_id`,`ie_project_name`,`ie_team_leaders`,`project_id`,`project_name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `configurations` VALUES ('website_footer','Powered by NADA 4.3 and DDI','Website footer text',NULL,NULL);
...
DROP TABLE IF EXISTS `featured_surveys`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `featured_surveys`
--

LOCK TABLES `featured_surveys` WRITE;
/*!40000 ALTER TABLE `featured_surveys` DISABLE KEYS */;
/*!40000 ALTER TABLE `featured_surveys` ENABLE KEYS */;
UNLOCK TABLES;
...
DROP TABLE IF EXISTS `survey_lic_requests`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `survey_lic_requests`
--

LOCK TABLES `survey_lic_requests` WRITE;
/*!40000 ALTER TABLE `survey_lic_requests` DISABLE KEYS */;
/*!40000 ALTER TABLE `survey_lic_requests` ENABLE KEYS */;
UNLOCK TABLES;
